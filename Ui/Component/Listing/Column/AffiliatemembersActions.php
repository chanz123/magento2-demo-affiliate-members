<?php
namespace Affiliate\Members\Ui\Component\Listing\Column;
class AffiliatemembersActions extends \Magento\Ui\Component\Listing\Columns\Column
{
    ...
    public function prepareDataSource(array $dataSource)
    {
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as & $item) {
                if (isset($item['affiliatemembers_id'])) {
                    $item[$this->getData('name')] = [
                        'edit' => [
                            'href' => $this->urlBuilder->getUrl(
                                static::URL_PATH_EDIT,
                                [
                                    'affiliatemembers_id' => $item['affiliatemembers_id']
                                ]
                            ),
                            'label' => __('Edit')
                        ],
